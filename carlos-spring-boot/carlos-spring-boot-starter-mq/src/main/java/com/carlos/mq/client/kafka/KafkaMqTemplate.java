...
public class KafkaMqTemplate implements MqTemplate {
    ...
    private final KafkaMqClient kafkaMqClient;
    ...
    public void sendAsync(String topic, Object message, SendCallback callback) {
        MqMessage<Object> mqMessage = MqMessage.builder()
            ...
            .body(message)
            .build();
        kafkaMqClient.sendAsync(mqMessage, callback);
    }
    ...
    public void sendOneWay(String topic, Object message) {
        MqMessage<Object> mqMessage = MqMessage.builder()
            ...
            .body(message)
            .build();
        kafkaMqClient.sendOneWay(mqMessage);
    }
    ...
    public SendResult sendDelayed(String topic, Object message, DelayLevel delayLevel) {
        MqMessage<Object> mqMessage = MqMessage.builder()
            ...
            .build();
        return kafkaMqClient.sendDelayed(mqMessage, delayLevel);
    }
    ...
    public SendResult sendDelayed(String topic, Object message, long delayTime, TimeUnit timeUnit) {
        MqMessage<Object> mqMessage = MqMessage.builder()
            ...
            .build();
        return kafkaMqClient.sendDelayed(mqMessage, delayTime, timeUnit);
    }
    ...
    public SendResult sendOrdered(String topic, Object message, String hashKey) {
        MqMessage<Object> mqMessage = MqMessage.builder()
            ...
            .ordered(true)
            .build();
        return kafkaMqClient.sendOrdered(mqMessage, hashKey);
    }
    ...
    public SendResult sendTransaction(String topic, Object message, Object arg) {
        MqMessage<Object> mqMessage = MqMessage.builder()
            ...
            .transactionArg(arg)
            .build();
        return kafkaMqClient.sendTransaction(mqMessage, arg);
    }
    ...
    @Override
    public boolean ping() {
        return kafkaMqClient.isConnected();
    }
     ...
     */
    public KafkaMqClient getClient() {
        return kafkaMqClient;
    }
}
