...
```java
import com.yunjin.oauth2.util.OAuth2Util;
...
| 配置项                     | 类型      | 默认值  | 说明           |
|-------------------------|---------|------|--------------|
| `yunjin.oauth2.enabled` | Boolean | true | 是否启用OAuth2模块 |
...
| `jwt.key-id`            | String  | yunjin-key-id         | 密钥ID          |
