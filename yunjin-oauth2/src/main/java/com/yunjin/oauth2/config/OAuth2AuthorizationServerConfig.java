...
import com.yunjin.oauth2.enhancer.JwtTokenEnhancer;
import com.yunjin.oauth2.service.DefaultOAuth2UserDetailsService;
import com.yunjin.oauth2.service.OAuth2UserDetailsService;
import com.yunjin.oauth2.util.JwtKeyUtil;
...
public class OAuth2AuthorizationServerConfig {
    ...
    private RegisteredClient buildDefaultClient(PasswordEncoder passwordEncoder) {
        return RegisteredClient.withId(UUID.randomUUID().toString())
                .clientId("yunjin-client")
                .clientSecret(passwordEncoder.encode("yunjin-secret"))
                .clientName("Yunjin Default Client")
                ...
                .redirectUri("http://localhost:8080/login/oauth2/code/yunjin")
