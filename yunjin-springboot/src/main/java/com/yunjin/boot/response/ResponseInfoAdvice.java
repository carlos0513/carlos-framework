package com.yunjin.boot.response;

import cn.hutool.json.JSONUtil;
import com.yunjin.boot.annotation.ClientApi;
import com.yunjin.boot.interceptors.ApplicationInterceptorProperties;
import com.yunjin.boot.interceptors.GlobalInterceptorProperties;
...
public class ResponseInfoAdvice implements ResponseBodyAdvice<Object> {
    ...
    public boolean supports(@Nullable final MethodParameter returnType, @Nullable final Class converterType) {
        ...
        // TODO: yunjin 2022/10/21 此处配置不需要进行统一响应处理的路径
