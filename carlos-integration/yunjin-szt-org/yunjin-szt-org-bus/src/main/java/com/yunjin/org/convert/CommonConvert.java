...
public class CommonConvert {
    ...
    public PageInfo<UserDepartmentVO> toUserVO(PageInfo<UserDepartmentDTO> userPages) {
        ...
        newUserPage.setSearchCount(userPages.isSearchCount());
        newUserPage.setOptimizeCountSql(userPages.isOptimizeCountSql());
        newUserPage.setOrders(userPages.getOrders());
