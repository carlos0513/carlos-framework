...
import com.yunjin.org.pojo.ao.UserMenuAO;
...
public class AppUserSessionVO implements Serializable {
    ...
    @Schema(value = "用户菜单")
    private List<UserMenuAO> menus;
    @Schema(value = "角色id列表")
    private Set<String> roleIds;
    @Schema(value = "所属部门信息")
    private List<AppDepartmentVO> departments;
    @Schema(value = "头像ID")
    private String head;
    @Schema(value = "介绍")
    ...
    @Schema(value = "当前部门信息")
    private AppDepartmentVO department;

    @Schema(value = "角色信息")
    private List<Role> roles;

    @Schema(value = "角色资源列表")
    private List<AppRoleResourceGroupItemVO> roleResources;
    @Schema(value = "角色权限组")
