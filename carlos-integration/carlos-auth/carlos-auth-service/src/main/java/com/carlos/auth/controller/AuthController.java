...
import com.carlos.auth.dto.LoginResponse;
import com.carlos.auth.security.IpBlockManager;
import com.carlos.auth.service.LoginService;
...
import com.carlos.auth.user.service.UserService;
...
public class AuthController {
    ...
    public Result<LoginResponse> login(@Valid @RequestBody LoginRequest loginRequest, HttpServletRequest httpRequest) {
        ...
        try {
            ...
            User user = userService.getByUsernameOrEmailOrPhone(loginRequest.getUsername());
            if (user != null) {
                // 检查登录失败次数
