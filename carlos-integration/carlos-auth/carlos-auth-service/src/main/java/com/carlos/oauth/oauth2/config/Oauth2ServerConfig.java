...
public class Oauth2ServerConfig {
    ...
    public SecurityFilterChain authorizationServerSecurityFilterChain(HttpSecurity http) throws Exception {
        ...
        // http.requestMatcher(authServerConfig.getEndpointsMatcher()).authorizeRequests(authorizeRequests -> authorizeRequests.authenticated()).apply(authServerConfig.authorizationService(authorizationService()).authorizationConsentService(authorizationConsentService())).and()
        //         // 授权码登录的登录页个性化
