...
public class LoginAuditEvent extends ApplicationEvent {
    ...
    public LoginAuditEvent(Object source, UserInfo user, HttpServletRequest request,
     ...
     * 构建登录成功事件
     */
    public static LoginAuditEvent loginSuccess(Object source, UserInfo user,
     ...
     * 构建登录失败事件
     */
    public static LoginAuditEvent loginFailure(Object source, UserInfo user,
     ...
     * 构建登出事件
     */
    public static LoginAuditEvent logout(Object source, UserInfo user,
                                         HttpServletRequest request, String sessionId) {
     ...
     * 构建账号锁定事件
     */
    public static LoginAuditEvent accountLocked(Object source, UserInfo user,
                                                HttpServletRequest request, String errorMessage) {
