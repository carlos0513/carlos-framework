package com.carlos.auth.aspect;

import com.carlos.auth.annotation.AuditLog;
import com.carlos.auth.entity.AuditOperation;
import com.carlos.auth.mapper.AuditOperationMapper;
...
public class OperationAuditAspect {
     ...
     * @throws Throwable 异常
     */
    @Around("@annotation(com.carlos.auth.annotation.AuditLog)")
     ...
     * 记录审计日志
     */
    private void recordAuditLog(User user, String operationType, String resourceType,
