...
```bash
# 创建数据库
mysql -u root -p < carlos-message-bus/src/main/resources/message_v2.sql
```
...
├── carlos-message-bus-api             # 服务端API层
├── carlos-message-bus-service         # 服务端业务层
├── carlos-message-bus-channel         # 渠道实现
├── carlos-message-bus-infrastructure  # 基础设施
...
| carlos-message-bus    | 服务端实现           | carlos-message-core, carlos-spring-boot-starter-* |
| carlos-message-boot   | 单机版启动入口         | carlos-message-bus                                |
| carlos-message-cloud  | 微服务版启动入口        | carlos-message-bus, spring-cloud-starter-*        |
