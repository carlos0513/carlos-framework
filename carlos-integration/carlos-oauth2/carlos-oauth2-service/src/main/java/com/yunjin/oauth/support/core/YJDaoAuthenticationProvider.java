...
import com.carlos.oauth.security.service.UserDetailServiceImpl;
 ...
 */
public class YJDaoAuthenticationProvider extends AbstractUserDetailsAuthenticationProvider {
    ...
    public YJDaoAuthenticationProvider() {
    ...
    protected void additionalAuthenticationChecks(UserDetails userDetails, UsernamePasswordAuthenticationToken authentication)
        ...
        Map<String, String> params = ServletUtil.getParamMap(RequestUtil.getRequest());
