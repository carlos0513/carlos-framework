...
**重构时间**: 2026-02-22  
**重构版本**: 3.0.0-SNAPSHOT  
**重构目标**: 将 `carlos-spring-boot-starter-oauth2` 合并至 `carlos-oauth2` 模块，升级至 Spring Boot 3.x 兼容版本
...
- **合并目标**: `carlos-integration/carlos-oauth2/carlos-oauth2-service/`
...
<dependency>
    <groupId>com.carlos</groupId>
    <artifactId>carlos-oauth2-service</artifactId>
</dependency>
<dependency>
    <groupId>com.carlos</groupId>
    <artifactId>carlos-oauth2-api</artifactId>
</dependency>
```
...
#### 6.1 carlos-oauth2-service/pom.xml 更新
...
```
carlos-integration/carlos-oauth2/carlos-oauth2-service/src/main/java/com/carlos/oauth/oauth2/config/OAuth2Properties.java
carlos-integration/carlos-oauth2/carlos-oauth2-service/src/main/java/com/carlos/oauth/oauth2/config/Oauth2ServerConfig.java
```
