...
import com.yunjin.org.pojo.entity.RoleMenu;
...
public interface RoleMenuManager extends BaseService<RoleMenu> {
     ...
     *
     * @param id 主键id
     * @return com.yunjin.org.pojo.dto.RoleMenuDTO
     * @author yunjin
     * @date 2022-11-11 19:21:46
     */
     ...
     *
     * @param roleId 角色id
     * @return java.util.List<com.yunjin.org.dto.sys.MenuAO>
     * @author Carlos
     ...
     * @Parameters: [roleIds]
     * @Return java.util.List<com.yunjin.system.pojo.dto.MenuAO>
     */
