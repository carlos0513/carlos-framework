...
-- 字段级变更明细表 (精细化审计)
-- ============================================
CREATE TABLE `audit_log_field_change`
(
    `id`             BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
    `audit_log_id`   BIGINT UNSIGNED NOT NULL,
    `data_change_id` BIGINT UNSIGNED NOT NULL,
    ...
    INDEX `idx_field` (`field_name`, `audit_log_id`)

) ENGINE = InnoDB
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_unicode_ci COMMENT ='审计日志-字段级变更明细';
