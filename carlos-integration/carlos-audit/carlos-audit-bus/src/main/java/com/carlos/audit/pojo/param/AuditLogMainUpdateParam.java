...
/**
 * <p>
 * 审计日志宽主表（合并数据变更、技术上下文、标签、附件，保留7天热数据） 更新参数封装
 * </p>
 *
 * @author Carlos
...
@Schema(description = "审计日志宽主表（合并数据变更、技术上下文、标签、附件，保留7天热数据）修改参数")
public class AuditLogMainUpdateParam {
    @NotNull(message = "主键，雪花ID不能为空")
