...
public class AuditLogMainCreateParam {
    ...
    @NotBlank(message = "状态: SUCCESS/FAIL/PENDING/TIMEOUT/PARTIAL_SUCCESS不能为空")
    ...
    @NotBlank(message = "操作描述(人工可读)不能为空")
    @Schema(description = "操作描述(人工可读)")
    private String operation;
    @NotNull(message = "风险等级 0-100不能为空")
    ...
    @NotNull(message = "是否有数据变更详情(0=否,1=是)不能为空")
