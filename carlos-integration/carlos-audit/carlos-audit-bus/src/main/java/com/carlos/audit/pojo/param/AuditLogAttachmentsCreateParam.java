...
@Schema(description = "审计日志-附件引用新增参数")
public class AuditLogAttachmentsCreateParam {
    @NotNull(message = "不能为空")
    @Schema(description = "")
    private Long auditLogId;
    @NotBlank(message = "类型: IMAGE/VIDEO/FILE/SNAPSHOT不能为空")
    @Schema(description = "类型: IMAGE/VIDEO/FILE/SNAPSHOT")
    private String attachmentType;
    @NotBlank(message = "存储: OSS/S3/MINIO/GRIDFS不能为空")
