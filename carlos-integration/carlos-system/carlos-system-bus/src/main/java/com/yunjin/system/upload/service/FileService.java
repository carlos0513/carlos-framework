...
public class FileService {
    ...
    public void downloadById(final String id, final HttpServletResponse response) {
        ...
        if (bytes == null) {
            ServletUtil.write(response, JSONUtil.toJsonStr(Result.fail("文件读取失败！")), ContentType.JSON.getValue());
            return;
        }
        ...
        try {
            ServletUtil.write(response, IoUtil.toStream(bytes), mimeType, fileName);
        } catch (Exception e) {
