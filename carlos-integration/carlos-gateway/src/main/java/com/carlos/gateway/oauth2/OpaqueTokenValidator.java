        ...
        return webClient.post()
            ...
            .flatMap(response -> {
                ...
                if (active == null || !active) {
                    return Mono.error(new ServiceException(StatusCode.UNAUTHORIZED, "Token is not active"));
                }
            ...
            .onErrorMap(e -> {
                ...
                return new ServiceException(StatusCode.UNAUTHORIZED, "Token validation failed");
            });
    }
